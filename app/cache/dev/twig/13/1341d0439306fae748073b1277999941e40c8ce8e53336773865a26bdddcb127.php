...
class __TwigTemplate_30619cf2906368afd4bdec76fd55bd5b704f39aa0e97d49949a408cd724b8cd1 extends Twig_Template
{
    ...
    {
        $__internal_bbeaf5833a88106152f3ebe08b977c848e8051a11f8ffa9410e641018108a7e5 = $this->env->getExtension("Symfony\\Bridge\\Twig\\Extension\\ProfilerExtension");
        $__internal_bbeaf5833a88106152f3ebe08b977c848e8051a11f8ffa9410e641018108a7e5->enter($__internal_bbeaf5833a88106152f3ebe08b977c848e8051a11f8ffa9410e641018108a7e5_prof = new Twig_Profiler_Profile($this->getTemplateName(), "template", "WebProfilerBundle:Router:panel.html.twig"));
...
<ul>
    <li>
        ...
        if ($this->getAttribute(($context["request"] ?? $this->getContext($context, "request")), "route", array())) {
            // line 7
            echo "            ";
            echo twig_escape_filter($this->env, $this->getAttribute(($context["request"] ?? $this->getContext($context, "request")), "route", array()), "html", null, true);
            echo "
        ";
        } else {
            // line 9
    ...
    <li>
        ...
        ";
        // line 14
        if (twig_length_filter($this->env, $this->getAttribute(($context["request"] ?? $this->getContext($context, "request")), "routeParams", array()))) {
            // line 15
            echo "            ";
            $this->loadTemplate("@WebProfiler/Profiler/table.html.twig", "WebProfilerBundle:Router:panel.html.twig", 15)->display(array("data" => $this->getAttribute(($context["request"] ?? $this->getContext($context, "request")), "routeParams", array()), "class" => "inline"));
            // line 16
            echo "        ";
        } else {
            // line 17
...
";
        ...
        $__internal_bbeaf5833a88106152f3ebe08b977c848e8051a11f8ffa9410e641018108a7e5->leave($__internal_bbeaf5833a88106152f3ebe08b977c848e8051a11f8ffa9410e641018108a7e5_prof);
...
", "WebProfilerBundle:Router:panel.html.twig", "/home/murilo/workspace/still-hamlet-13528/vendor/symfony/symfony/src/Symfony/Bundle/WebProfilerBundle/Resources/views/Router/panel.html.twig");
    }
}
